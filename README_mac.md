...
'test: '+Math.random() =>>test: 0.8751247535005682
```
...
let b=3;
2*b*Math.random() =>>2.2278771372460264
eval('let b=3; 2*b*Math.random()')=>>0.6986671274134988
console.log(a,Math.random())
'hello '+(2-1+Math.random())=>>hello 1.4123082153413218
process.cwd() =>>/Users/kellycogan/Documents/GitHub/hover-exec
console.log(abc)
```
```output
goodbye world 0.5396070223698353
hello, world 3
```
